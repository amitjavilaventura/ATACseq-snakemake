...
sample1=$1 #condition (ex. apc KO)
sample2=$2 #control (ex. WT plus WNT)

mkdir -p 04peak_annot/ \
04peak_annot/uniquePeaks/ \
04peak_annot/uniquePeaks/${sample1}-vs-${sample2}/
...
05_overlaps/bedtools/${sample1}-vs-${sample2}/${sample1}_unique_peaks.bed \
04peak_annot/uniquePeaks/${sample1}-vs-${sample2}/${sample1}_unique_peakAnnot.bed \
04peak_annot/uniquePeaks/${sample1}-vs-${sample2}/${sample1}_unique_peakAnnot_promoTargets.bed \
04peak_annot/uniquePeaks/${sample1}-vs-${sample2}/${sample1}_unique_peakAnnot_promoTargets.txt \
04peak_annot/uniquePeaks/${sample1}-vs-${sample2}/${sample1}_unique_peakAnnot_promoPeaks.bed \
04peak_annot/uniquePeaks/${sample1}-vs-${sample2}/${sample1}_unique_peakAnnot_distalPeaks.bed \
04peak_annot/uniquePeaks/${sample1}-vs-${sample2}/${sample1}_unique_peakAnnot_distalTargets.bed \
04peak_annot/uniquePeaks/${sample1}-vs-${sample2}/${sample1}_unique_peakAnnot_distalTargets.txt